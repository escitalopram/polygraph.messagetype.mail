...
@TagInfo(name="sender", body=BodyExistence.FORBIDDEN, nestable=false)
public class SenderTag implements PolygraphTag {
	
	@TagParameter
	private String email;
	
	@TagParameter(optional=true)
	private String name;
	...
	public void execute(PolygraphEnvironment env) throws IOException {
		...
		MailAddress a=new MailAddress(name, email);
		m.getDescription().setSender(a);
	}
